...
## Future Data Work Flow: pavement assessment via ML models trained on real world data and synthetic road data
* Real Road Data
...
* Synthetic road data could be generated after importing the profiled road data into OpenUSD. Randomization could be performed to generate more data for road edge cases, following this work flow from the official Nvidia docs:
